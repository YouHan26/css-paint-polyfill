...
var FORCED$3 = NEGATIVE_ZERO$1 || !STRICT_METHOD$2 || !USES_TO_LENGTH$2;
...
var EsPaintWorklet = /*#__PURE__*/function () {
  function EsPaintWorklet() {
    ...
    var supportsStyleMutations = false;
    var lock = false;
    ...
    setTimeout(function () {
      ...
      if (!supportsStyleMutations) {
        ...
        var oldStyleGetter = styleDesc.get;

        styleDesc.get = function () {
          var style = oldStyleGetter.call(this);
          style.ownerElement = this;
          return style;
        };

        defineProperty$6(HTMLElement.prototype, 'style', styleDesc);
        var cssTextDesc = Object.getOwnPropertyDescriptor(CSSStyleDeclaration.prototype, 'cssText');
        var oldSet = cssTextDesc.set;
        ...
        defineProperty$6(CSSStyleDeclaration.prototype, 'cssText', cssTextDesc);
        var setPropertyDesc = Object.getOwnPropertyDescriptor(CSSStyleDeclaration.prototype, 'setProperty');
        var oldSetProperty = setPropertyDesc.value;
        ...
        defineProperty$6(CSSStyleDeclaration.prototype, 'setProperty', setPropertyDesc);
      }
    });
  }
